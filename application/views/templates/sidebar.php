...
// Parent accordion active states – use the EXACT values you saw
$itemMonitoringActive = in_array($current, ['items', 'itemized'], true); // keep as is for now

$borrowingMonitoringActive = in_array($current, ['Borrowing', 'Reservation', 'Return_c'], true);
?>

// Parent accordion active states
$itemMonitoringActive = in_array($current, ['items', 'itemized'], true);
$borrowingMonitoringActive = in_array($current, ['borrowing', 'reservation', 'returns'], true);
?>
...
<div id="sidebar">
    ...
    <div class="sidebar-header">
        <a href="<?= base_url('dashboard') ?>" class="sidebar-brand">
            <img src="<?= base_url('assets/images/logo.png') ?>" alt="ARMS-BMS Logo">
            <span class="brand-copy">
                <strong>A.R.M.S</strong><br>
                <small>Borrowing Management</small>
            </span>
        </a>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <!-- Users (controller is "User" → lowercase "user") -->
        ...
        <!-- ==================== Item Monitoring ==================== -->
        <div class="accordion sidebar-accordion" id="itemMonitoringAccordion">
                ...
                <div class="card-header" id="itemMonitoringHeading">
                    <h2 class="mb-0">
                        <button type="button"
                            ...
                            <span class="nav-label">Item Monitoring</span>
                            <i class="fas fa-chevron-down chevron"></i>
                        </button>
                    </h2>
                </div>

                <div id="itemMonitoringCollapse"
                    ...
                    <div class="card-body sidebar-submenu">
                        <a href="<?= base_url('items') ?>"
                            class="sidebar-link sidebar-sublink <?= $current === 'items' ? 'active' : '' ?>"
                            data-title="Items">
                        ...
                        <a href="<?= base_url('itemized') ?>"
                            class="sidebar-link sidebar-sublink <?= $current === 'itemized' ? 'active' : '' ?>"
                            data-title="Itemized">
        ...
        <div class="accordion sidebar-accordion" id="borrowingMonitoringAccordion">
            <div class="card sidebar-accordion-item">
                <div class="card-header" id="borrowingMonitoringHeading">
                    <h2 class="mb-0">
                        <button type="button"
                            ...
                            <span class="nav-label">Borrowing Monitoring</span>
                            <i class="fas fa-chevron-down chevron"></i>
                        </button>
                    </h2>
                </div>

                <div id="borrowingMonitoringCollapse"
                    ...
                    <div class="card-body sidebar-submenu">
                        <a href="<?= base_url('borrowing') ?>"
                            class="sidebar-link sidebar-sublink <?= $current === 'Borrowing' ? 'active' : '' ?>"
                        ...
                        <a href="<?= base_url('reservation') ?>"
                            class="sidebar-link sidebar-sublink <?= $current === 'Reservation' ? 'active' : '' ?>"
                        ...
                        <a href="<?= base_url('returns') ?>"
                            class="sidebar-link sidebar-sublink <?= $current === 'Return_c' ? 'active' : '' ?>"
                            data-title="Returns">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-footer-content">
            ...
            <span class="nav-label">ARMS-BMS 2026</span>
        </div>
    </div>
