$(document).ready(function () {
    if ($('#summaryOverdueTable').length === 0) return;

    $('#summaryOverdueTable').DataTable({
        processing: true,
        serverSide: true,
        pageLength: 10,
        ajax: {
            ...
            type: 'POST',
            data: function (d) { d.item_status = 'overdue'; } // permanently filtered
        },
        columns: [
        ...
        order: [[9, 'asc']],
        language: { emptyTable: 'No overdue items. 🎉' }
    });
});