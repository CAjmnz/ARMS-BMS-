$(document).ready(function () {
	...
	$("#btnSaveUnit").click(function () {
		...
		var url = id
			? BASE_URL + "itemized/update/" + id
			: BASE_URL + "itemized/store";
	...
	// Reset checkboxes when DataTable redraws
	...
	$("#btnSelect").on("click", function () {
		...
		// Show bulk delete and cancel buttons
		$("#btnBulkDelete").removeClass("d-none");
	...
	$("#btnCancelSelect").on("click", function () {
		...
		// Hide checkbox column in header
		$(".checkbox-col").hide();
	...
	table.on("draw", function () {
		...
		// Hide checkbox column if not in select mode
		if (!selectMode) {
			$(".checkbox-col").hide();
			$("td.checkbox-td").hide();
		} else {
